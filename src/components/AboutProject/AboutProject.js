  ...
  return (
    <section className="about-project" id="aboutProject" aria-label="О проекте">
      ...
      <div className="about-project__info">
        <div
          className="about-project__section"
          aria-label="Описание этапов"
        >
          <h3 className="about-project__section-subtitle">
        ...
        <div
          className="about-project__section"
          aria-label="Описание сроков выполнения диплома"
        >
          <h3 className="about-project__section-subtitle about-project__section-subtitle_removed">
      ...
      <div
        className="about-project__section-infoblock"
        aria-label="О времени на задачи"
      >
