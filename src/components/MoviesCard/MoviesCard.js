    ...
    return mainApi
      ...
      .then((res) => {
        ...
        localStorage.setItem(
          "savesMovies",
          JSON.stringify([res, ...savesMovies])
        );
      })
      .catch((err) => {
        setIsSaved(false);
  ...
  function handleDeleteMovie(movie) {
    ...
    mainApi
      ...
      .then((res) => {
        ...
        localStorage.setItem(
          "savesMovies",
          JSON.stringify(savesMovies.filter((item) => item._id !== movieId))
        );
      })
      .catch((err) => {
        setIsSaved(true);
  ...
  return (
    <li className="movie">
      ...
      <div className="movie__container">
        ...
        <button
          className={`movie__button-save-like ${
            isSaved ? "movie__button-save-like_active" : ""
          } ${deleteBg ? "movie__button-save-close" : ""}`}
          type="button"
